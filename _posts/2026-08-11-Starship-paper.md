...
image: images/papers/2026_siderophore.png
...
Discovery of giant transposons Starships challenged what we thought we knew about fungal genomes. But what about Starships in lichen fungi? In the paper, we present the Tangerine element from Xanthoria parietina. Tangerine has all hallmark features of a Starship: 100 kb in length, the captain gene responsible for transposition, as well as accessory genes and ‘cargo’. Tangerine’s captain didn’t fit into any existing family of Starship captains, but in the tree it grouped together with several genes from other lichen fungi. After expanding our analyses to many more genomes, we were able to describe the clade as the new family, the Tangerine-family, unique to Lecanoromycetes.
